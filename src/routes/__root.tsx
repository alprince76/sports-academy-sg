...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Platform manajemen akademi basket modern untuk perkembangan atlet muda." },
      ...
      { property: "og:description", content: "Platform manajemen akademi basket modern untuk perkembangan atlet muda." },
      { name: "twitter:description", content: "Platform manajemen akademi basket modern untuk perkembangan atlet muda." },
