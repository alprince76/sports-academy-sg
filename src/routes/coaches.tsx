...
function CoachesPage() {
  ...
  return (
    <DashboardLayout
      title="Coaches"
      subtitle="Kelola tim pelatih akademi basket"
      actions={
    ...
    >
            ...
            <CardContent className="p-5">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
                <div className="rounded-lg bg-secondary/50 p-2">
                  ...
                  <p className="font-semibold">{c.teams}</p>
                </div>
                <div className="rounded-lg bg-secondary/50 p-2">
                  <p className="text-muted-foreground">Athletes</p>
                  <p className="font-semibold">{c.athletes}</p>
                </div>
              </div>
      ...
      <AddCoachDialog open={addOpen} onOpenChange={setAddOpen} />
    </DashboardLayout>
  );
}
